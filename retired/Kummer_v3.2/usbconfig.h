...
#elif JOY2
#define  USB_CFG_DEVICE_ID       0x01, 0xe6
#elif JOY3
#define  USB_CFG_DEVICE_ID       0x01, 0xe7
#elif JOY4
#define  USB_CFG_DEVICE_ID       0x01, 0xe8
#endif
 ...
 */
#ifdef JOY1
#define USB_CFG_DEVICE_NAME     'J', 'o', 'y', 's', 't', 'i', 'c', 'k', ' ', '1'
#elif JOY2
#define USB_CFG_DEVICE_NAME     'J', 'o', 'y', 's', 't', 'i', 'c', 'k', ' ', '2'
#elif JOY3
#define USB_CFG_DEVICE_NAME     'J', 'o', 'y', 's', 't', 'i', 'c', 'k', ' ', '3'
#elif JOY4
#define USB_CFG_DEVICE_NAME     'J', 'o', 'y', 's', 't', 'i', 'c', 'k', ' ', '4'
#endif
