/* "ColecoVision" mouse to USB (interrupt version)
...
static void ColecoVisionMouseInit(void);
...
/* QEM explanation:
 *
 * Quadrature from an ColecoVision mouse is made of two 90 degree out of phase signals that corresponds to
...
#define MOUSE_BUT3	PC3
	 ...
	 */
	 ...
	 // Sub controller 2 selected by default
